      ...
      <section className="container pt-4 pt-md-3 mt-2 mt-md-0 mb-5 pb-5">
        ...
        <Card className="card-data-container card-data-container__form mt-2">
          ...
          <div className="title-card-container d-flex flex-column flex-sm-row">
            <h1 className="title-card-data my-3 my-md-0">Crear perfil</h1>
              ...
              <form action="">
                <div className="row">
                  ...
                  <div className="col-md-6 col-lg-3 mb-3">
                    <div className="d-flex flex-column">
                      <InputText id="codigoPerfil" placeholder="Código del perfil" aria-describedby="codigo-del-perfil" className="order-1"/>
                  ...
                  <div className="col-lg-6 mb-3">
                    <div className="d-flex flex-column">
                      <InputText id="nombrePerfilEs" placeholder="Nombre del perfil en Castellano" aria-describedby="nombre-del-perfil-en-castellano" className="order-1"/>
                  ...
                  <div className="col-lg-6">
                    <div className="d-flex flex-column">
                      <InputText id="nombrePerfilEu" placeholder="Nombre del perfil en Euskera" aria-describedby="nombre-del-perfil-en-euskera" className="order-1"/>
                ...
                <div className="inner-card-table">
                  <div className="row mt-3">
                    <label htmlFor="tableGruposPermisos">Asignar grupos de permisos</label>
                    <PaginatorLabel />
                    <DataTable  value={gruposPermisos}
                                size="normal"
                                stripedRows
                                removableSort
                                id="tableGruposPermisos"
                                filtermode="contains"
                                filterDisplay="row"
