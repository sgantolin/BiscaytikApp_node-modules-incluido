...
function ReactivacionMasivaUsuarios() {
  ...
  //funciones botones guardar reactivación masiva y cerrar dialog
  ...
  const handleGuardarBtn = () => {
    ...
    if(guardarExitoso) {
      toast.current.show({  severity: 'success', 
                            summary: 'Reactivación masiva correcta', 
                            detail: 'Se han reactivado los usuarios seleccionados.'
                        });
      ...
      toast.current.show({  severity: 'error', 
                            summary: 'Error reactivación masiva', 
                            detail: `No se han podido reactivar los usuarios seleccionados.`
                          });
      setGuardarExitoso(true);
      
    }
  };
  //FIN funciones botones guardar reactivación masiva y cerrar dialog
  ...
  const handleReactivacionEntidadesBtn = () => {
      setVisible(true);
  };
  ...
  const footerContent = (
    <div>
      ...
      <Button label="Reactivar" onClick={() => handleGuardarBtn()} className="p-button-primary btn-loading">
  ...
  const handleReactivacionUsuariosBtn = () => {
      setVisible2(true);
  };
  ...
  return (
    <>
      <section className="container pt-4 pt-md-3 mt-2 mt-md-0 mb-5 pb-5">
        <h1 className="section-title">Reactivación masiva de usuarios</h1>
         {/*<p className="section-subtitle">
          La reactivación masiva de usuarios permite volver a activar masivamente a los usuarios del sistema que previamente se encontraban dados de baja, tanto en la propia aplicación como en LDAP.
        </p> */}
                  ...
                  <>
                    <div className="row">
                      <div className="col mb-3 mt-4 d-flex flex-column flex-md-row justify-content-end">
                          <Button onClick={handleReactivacionEntidadesBtn} label="Reactivación por entidades" icon="fa-regular fa-building" type="button" className="p-button-outlined w-30 me-0 me-md-4 mb-3 mb-md-0" />
                          <Button onClick={handleReactivacionUsuariosBtn} label="Reactivación por usuarios" icon="fa-regular fa-user-large" type="button" className="p-button-outlined w-30" />
                      </div>
                    </div>
                  </>
                )}
        ...
        <Dialog visible={visible} onHide={hideDialog} footer={footerContent} className="system-dialog clonar-dialog dialog-min-width dialog-smaller">
          <h4 className="pb-4">Reactivación por entidades</h4>
              <p className="mt-0">
                Seleccione una o varias entidades para las que se deseen reactivar los usuarios asociados.
              </p>
        ...
        <Dialog visible={visible2} onHide={hideDialog2} footer={footerContent2} className="system-dialog clonar-dialog dialog-min-width dialog-smaller">
          <h4 className="pb-4">Reactivación por usuarios</h4>
              <p className="mt-0">
                Seleccione uno o varios usuarios a los que se deseen reativar para la aplicación seleccionada.
              </p>
              <div className="d-flex flex-column mt-4 mb-5">
...
export default ReactivacionMasivaUsuarios
