      ...
      <section className="container pt-4 pt-md-3 mt-2 mt-md-0 pb-5 mb-5">
        ...
        <Card className="card-data-container mt-2">
          ...
          <div className="title-card-container d-flex flex-column flex-sm-row">
            <h1 className="title-card-data my-3 my-md-0">Crear permisos para {'"Nombre"'}</h1>
            <div className="title-button-container ms-sm-auto">
              <Button onClick={handleVolverBtn} icon="fa-regular fa-arrow-left" label="Volver a asignación de permisos" text type="button" className="p-button pe-4 pe-sm-0" />
            </div>
          </div>
        ...
        <div className="tabs-container mt-4 pt-2 mb-3 pb-3">
          <div className="table-container">
            <TabView>
              ...
              <h3 className="title-card-data">Permisos</h3>
                ...
                <div className="buttons-container d-flex flex-column flex-md-row justify-content-end">
